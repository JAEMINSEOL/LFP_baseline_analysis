function DrawRawEEG_JM(EEG,index,ts_trial,trialNum_iter,sessionID,thisCSCID,RegionIndex)
...
plot(EEG.eeg,'k-');
                    ...
                    xlim([index.eeg(1)-1 index.eeg(end)]);
                    ylim([-ymax ymax]);
                    
                    hold on;
                    ElapsedTime = round((ts_trial(end-1)-ts_trial(1))*100)/100;
